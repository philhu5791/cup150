...
public class Graph {
    ...
    protected Vector<gNode> nodes = new Vector<gNode>();
    ...
    public Vector<gNode> getNeighbors(gNode a) {
        Vector<gNode> neighbors = new Vector<gNode>();
